...
require.config({
  paths: {
          'bootstrap-tour': "../../../webjars/bootstrap-tour/js/bootstrap-tour.min.js"
      },
  shim: {
    'bootstrap-tour': {
...
require(['jquery', 'xwiki-meta'], function ($, xm) {
  ...
  var createResumeButton = function (tour, createPopover) {
    ...
    var button = $('<button id="tourResume" class="btn btn-default btn-xs"><img src="../../../resources/icons/silk/information.png" alt="Icon" /> Show tour</button>').appendTo(buttonContainer);
  ...
  var addCloseButton = function (tour) {
    var button = $('<button class="btn btn-xs btn-default" data-role="end" style="position: absolute; top: 3px; right: 5px;"><img src=\"..\/..\/..\/resources\/icons\/silk\/cross.png\" alt=\"Icon\" \/></button>').appendTo($('.tour'));
  ...
  var createTour = function (jsonData) {
    ...
    var cssURL = "../../../webjars/bootstrap-tour/css/bootstrap-tour.min.css";
